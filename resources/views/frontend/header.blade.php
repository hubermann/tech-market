              ...
              <div class="js-scrollbar g-height-200">
                  ...
                  <div class="row no-gutters g-pb-5">
                    <div class="col-4 pr-3">
                      <a class="u-basket__product-img" href="#">
                        <img class="img-fluid" src="{{ asset('front/assets/img-temp/150x150/img1.jpg') }}" alt="Image Description">
                      </a>
                    </div>
                ...
                <div class="u-basket__product g-brd-none g-px-20">
                  <div class="row no-gutters g-pb-5">
                    <div class="col-4 pr-3">
                      <a class="u-basket__product-img" href="#">
                        <img class="img-fluid" src="{{ asset('front/assets/img-temp/150x150/img2.jpg') }}" alt="Image Description">
                      </a>
                    </div>
                ...
                <div class="u-basket__product g-brd-none g-px-20">
                  <div class="row no-gutters g-pb-5">
                    <div class="col-4 pr-3">
                      <a class="u-basket__product-img" href="#">
                        <img class="img-fluid" src="{{ asset('front/assets/img-temp/150x150/img3.jpg') }}" alt="Image Description">
                      </a>
                    </div>
                ...
                <div class="u-basket__product g-brd-none g-px-20">
                  <div class="row no-gutters g-pb-5">
                    <div class="col-4 pr-3">
                      <a class="u-basket__product-img" href="#">
                        <img class="img-fluid" src="{{ asset('front/assets/img-temp/150x150/img4.jpg') }}" alt="Image Description">
                      </a>
                    </div>
    ...
    <nav class="js-mega-menu navbar navbar-expand-lg">
      <div class="container">
        ...
        <a class="navbar-brand" href="home-page-1.html">
          <img src="{{ asset('front/assets/img/logo/logo-1.png') }}" alt="Image Description">
        </a>
        <!-- End Logo -->
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
                    <article class="g-pos-rel">
                      <img class="img-fluid" src="{{ asset('front/assets/img-temp/700x700/img1.jpg') }}" alt="Image Description">
            ...
            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-15--xl"
              ...
              <div class="w-100 hs-mega-menu u-shadow-v11 g-text-transform-none g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-mt-17" aria-labelledby="mega-menu-label-2">
                <div class="row no-gutters">
                  ...
                  <div class="col-md-8 g-min-height-400 g-bg-size-cover g-bg-pos-center" data-bg-img-src="{{ asset('front/assets/img-temp/700x467/img1.jpg') }}">
            ...
            <li class="hs-has-mega-menu nav-item g-ml-10--lg g-ml-15--xl"
              ...
              <div class="w-100 hs-mega-menu u-shadow-v11 g-text-transform-none g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-pa-30 g-mt-17" aria-labelledby="mega-menu-label-5">
                <div class="row">
                  <div class="col-md-4 g-mb-30 g-mb-0--md">
                    <!-- Article -->
                    <article class="g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-bluegray-opacity-0_3--after text-center g-px-40 g-py-80" data-bg-img-src="{{ asset('front/assets/img-temp/600x400/img1.jpg') }}">
                  ...
                  <div class="col-md-4 g-mb-30 g-mb-0--md">
                    <!-- Article -->
                    <article class="g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-bluegray-opacity-0_3--after text-center g-px-40 g-py-80" data-bg-img-src="{{ asset('front/assets/img-temp/600x400/img2.jpg') }}">
                      <div class="g-pos-rel g-z-index-1">
                  ...
                  <div class="col-md-4 g-mb-30 g-mb-0--md">
                    <!-- Article -->
                    <article class="g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-bluegray-opacity-0_3--after text-center g-px-40 g-py-80" data-bg-img-src="{{ asset('front/assets/img-temp/600x400/img3.jpg') }}">
                      <div class="g-pos-rel g-z-index-1">
