  ...
  <div class="row g-mx-minus-10 g-mb-50">
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        ...
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img1.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img2.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img3.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img4.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img5.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img6.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img7.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img8.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
    ...
    <div class="col-md-6 col-lg-4 g-px-10">
      ...
      <article class="media g-brd-around g-brd-gray-light-v4 g-bg-white rounded g-pa-10 g-mb-20">
        <!-- Article Image -->
        <div class="g-max-width-100 g-mr-15">
          <img class="d-flex w-100" src="{{ asset('front/assets/img-temp/150x150/img9.jpg') }}" alt="Image Description">
        </div>
        <!-- End Article Image -->
